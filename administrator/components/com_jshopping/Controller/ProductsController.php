...
class ProductsController extends BaseadminController{
    ...
    function editlist(){
        ...
        $lists['categories'] = \JHTML::_('select.genericlist', $categories, 'category_id[]', 'class="inputbox form-control form-select" size="10" multiple = "multiple" '.$category_select_onclick, 'category_id', 'name');
